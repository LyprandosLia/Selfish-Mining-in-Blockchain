...
ALPHA: float = 12.0       # Strategic Premium gained from private chain extension
C: float = 9.0              # Cost of Mining (electricity & hardware, deliberately
...
# =============================================================================
KAPPA: float = 0.3          # Marginal Delay Cost (risk coefficient per unit time)
...
# =============================================================================
GAMMA: float = 0.7          # Propagation Advantage in [0, 1] (Eyal & Sirer, 2013).
